...
declare type EventTypeUndefined =
  | 'calendar.nextMonth'
  | 'calendar.nextYear'
  | 'calendar.nextYears'
  | 'calendar.prevMonth'
...
export declare type EventType =
  ...
  | EventTypeDateOrNull
  | EventTypeDataToView
export declare type EventDispatcher = <T extends EventType>(
  type: T,
...
declare type DivProps = DetailedHTMLProps<
  HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
>
declare type ButtonProps = DetailedHTMLProps<
